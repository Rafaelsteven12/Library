...
<html lang="en">
    ...
    <head>
        ...
        <!-- Basic -->
        <title>LSPU Online Library | Home</title>
            ...
            <div class="navbar navbar-default navbar-top">
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="<?php echo web_root;?>">LSPU Online Library</a>
                    </div>
                    <div class="navbar-collapse collapse">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li>
                                <a class="<?php echo ($q=='' && strpos($_SERVER['REQUEST_URI'], 'borrower') === false) ? 'active' : ''?>" href="<?php echo web_root;?>">Home</a>
                            </li> 
                            <li >
                            ...
                            <?php if (isset($_SESSION['BorrowerId'])): ?>
                                <li>
                                    <a class="<?php echo ($q=='profile' || strpos($_SERVER['REQUEST_URI'], 'borrower') !== false) ? 'active' : ''?>" href="<?php echo web_root;?>borrower">Profile</a>
                                </li>
                                <li>
                            ...
                            <?php else: ?>
                                <li>
                                    <a class="<?php echo ($q=='login')? 'active' : ''?>" href="<?php echo web_root;?>index.php?q=login">Login</a>
                                </li>
                                <!-- <li>
                                    <a class="<?php echo ($q=='register')? 'active' : ''?>" href="<?php echo web_root;?>index.php?q=register">Register</a>
                                </li> -->
                            <?php endif; ?>
                            <!-- <li>
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="footer-address">
                            <ul>
                                <li class="footer-contact"><i class="fa fa-home"></i>38M6+6VQ, Cosico Ave, San Pablo City, 4000 Laguna</li>
                                <li class="footer-contact"><i class="fa fa-envelope"></i><a href="https://mail.google.com/mail/u/2/#inbox?compose=new&to=lspuspcc.edu.ph" target="blank">lspuspcc@lspu.edu.ph</a></li>
                                <li class="footer-contact"><i class="fa fa-phone"></i>(049562) 8130</li>
