...
INSERT INTO `tblusers` (`USERID`, `NAME`, `UEMAIL`, `PASS`, `TYPE`, `Status`, `PicLoc`) 
VALUES
(1, 'Administrator', 'ADMIN', 'admin', 'Administrator', 'Active', 'img/bhl-logo.jpg'),
(2, 'Admin2', 'admin1', 'admin1', 'Administrator', 'Active', ''),
