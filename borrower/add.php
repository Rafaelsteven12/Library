        ...
        <form class="form-horizontal span6  wow fadeInDown" action="controller.php?action=add" method="POST" enctype="multipart/form-data">
          ...
          <div class="row">
            ...
            <div class="row">
              ...
              "BorrowerId">Student Number</label>
              <div class="col-md-8"> 
            <input class="form-control input-sm" id="BorrowerId" name="BorrowerId" placeholder="Student Number" type="text" value="" required>  
            </div>
              <!-- <div class="col-md-8"> 
